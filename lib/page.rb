...
class Page
  ...
  def is_valid_link_for_hash_for_existance_checking?(link_string, hash)
    return ((hash.has_key?(link_string.capitalize) or hash.has_key?(self.class.upcase_first_letter(link_string))) and (link_string.capitalize != self.title) and self.class.upcase_first_letter(link_string) != self.title)
  end
  ...
  def is_valid_link_for_hash?(link_string, hash)
    return (hash.has_key?(self.class.upcase_first_letter(link_string)) and self.class.upcase_first_letter(link_string) != self.title and link_string != self.title)
  end
